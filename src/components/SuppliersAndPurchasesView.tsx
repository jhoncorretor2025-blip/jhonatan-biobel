...
export function SuppliersAndPurchasesView({
  ...
  const handleAddSupplier = () => {
    ...
    setNewSupplier({ name: '', cnpj: '', phone: '', brand: '' });
  };
  ...
  const handleUpdateSupplierField = (index: number, field: string, value: string) => {
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-150 dark:border-slate-800 shadow-xs p-6 space-y-4">
              ...
              <div className="space-y-3">
                {filteredSuppliers.map((prov: any, index: number) => (
                  <div key={prov.id} className="bg-slate-50 dark:bg-slate-950 p-4 rounded-2xl border border-slate-100 dark:border-slate-850 grid grid-cols-1 sm:grid-cols-5 gap-3 items-end text-left">
                    <div className="space-y-1">
                      ...
                      <input 
                        ...
                        className="w-full bg-white dark:bg-slate-800 border-none p-2.5 text-xs font-bold rounded-lg text-slate-900 dark:text-white uppercase"
                      />
                    </div>
                    <div className="space-y-1">
                      ...
                      <input 
                        ...
                        className="w-full bg-white dark:bg-slate-800 border-none p-2.5 text-xs font-bold rounded-lg text-slate-900 dark:text-white"
                      />
                    </div>
                    <div className="space-y-1">
